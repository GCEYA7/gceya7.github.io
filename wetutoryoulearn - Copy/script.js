...
/* =========================================================
       4. ENGAGE MODALS LOGIC
       ========================================================= */
    const learnMoreBtns = document.querySelectorAll('.btn-outline');
    const closeBtns = document.querySelectorAll('.close-modal');
    const engageModals = document.querySelectorAll('.engage-modal');
    ...
    closeBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            engageModals.forEach(modal => modal.classList.remove('active'));
            document.body.style.overflow = ''; // Restores scrolling
        });
    });

    // Close Modals by clicking the dark background outside the box
    engageModals.forEach(modal => {
...
const openBtns = document.querySelectorAll(".open-register-btn"); // Grabs EVERY register button

// 2. Open the modal when ANY register button is clicked
...
// 4. Close the modal if the user clicks the dark background outside the form
